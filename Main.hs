...
ageOn planet ageInSeconds =
  ...
  "Mercury" -> Right $ ageInEarthYears / 0.2408467
  "Venus" -> Right $ ageInEarthYears / 0.61519726
  "Earth" -> Right ageInEarthYears
  "Mars" -> Right $ ageInEarthYears / 1.8808158
  "Jupiter" -> Right $ ageInEarthYears / 11.862615
  "Saturn" -> Right $ ageInEarthYears / 29.447498
  "Uranus" -> Right $ ageInEarthYears / 84.016846 
  "Neptune" -> Right $ ageInEarthYears / 164.79132
  "Pluto" ->  Left "This is not a planet!"
  _ -> Left "Unrecognised planet!"

isLeapYear :: Int -> Maybe Bool
isLeapYear year 
  | year < 0 = Nothing
  | otherwise = Just (mod year 4 == 0 && (mod year 100 /= 0 || mod year 400 == 0))
